...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen translate-x-[50%] w-full flex-col-reverse p-4 top-0 right-1/2 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariants({ variant }), className, "toast-slide-up")}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-semibold [&+div]:text-xs font-sans", className)}
    {...props}
  />
));
